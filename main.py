...
if not os.path.exists('data.csv'):
    open("data.csv","w")
APP_ID = 27166562
API_HASH = "68af25234bcf23fb3bead6cca6534a42"
BOT_TOKEN = "5736708726:AAHWkpWD7PUxLrWZpj2YGuvjNDwFf9Vih9w"
UPDATES_CHANNEL = "jvpvipchat"
